...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Work/Vivado/14.4/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.cache/ip [current_project]
  set_property ip_output_repo c:/Work/Vivado/14.4/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.cache/ip [current_project]
  add_files -quiet C:/Work/Vivado/14.4/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.runs/synth_1/vga_ctrl.dcp
...
set rc [catch {
  ...
  if { [file exists C:/Work/Vivado/14.4/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.runs/synth_1/vga_ctrl.hwdef] } {
    catch { write_sysdef -hwdef C:/Work/Vivado/14.4/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.runs/synth_1/vga_ctrl.hwdef -bitfile vga_ctrl.bit -meminfo vga_ctrl.mmi -file vga_ctrl.sysdef }
  }
